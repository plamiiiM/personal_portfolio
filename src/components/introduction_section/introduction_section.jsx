  ...
  return (
    <section className="flex flex-col justify-start items-start gap-y-14 font-[poppins] w-2xl letter-spacing-wide tracking-wide  mb-10">
      <div className="flex flex-col gap-y-14">
        ...
        <p className="text-lg  leading-8 letter-spacing-wide">
          Currently obtaining a Bachelor in ICT and Media Design at Fontys UAS.
          <br /> <br /> An eager junior designer with lots of on-hands practice
          in different real-life projects. Working with real businesses, during
          my studies I've helped several companies in the Eindhoven region
          better their designs and improve quality.
        </p>
      </div>
