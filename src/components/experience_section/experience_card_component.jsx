...
export function ExperienceCardComponent({
  ...
  return (
    <div className="flex flex-col font-[poppins] text-lg leading-9">
      <div className="absolute left-0 top-15 w-6 h-6 bg-pink-600 rounded-full "></div>

      <h2 className=" mb-8">{year ? `${year}` : "Year"}</h2>
      <p>
